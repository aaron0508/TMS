<?php
 ...
 if(isset($_POST['edit_task'])){
    $query = "update tasks set uid = $_POST[id],description = '$_POST[
        description]',start_date = '$_POST[start_date]',end_date = '$_POST
        [end_date]' where tid = $_GET[id]";
...
<div class="form-group">
    ...
    <textarea class="form-control" rows="3" cols="50" name="description" required><?php echo $row1['description']; ?>
</textarea>
<div class="form-group">
                ...
                <input type="submit" class="btn btn-warning" name="edit_task
                "value="Update">
</div>
